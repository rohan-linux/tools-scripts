...
TARGET_RESULT=result-nxp3220-daudio2
...
# For Kernel
TARGET_KERNEL_DEFCONFIG=nxp3220_daudio2_defconfig
TARGET_KERNEL_DTB=nxp3220-daudio2-rev00
TARGET_KERNEL_IMAGE=Image

# For U-boot
TARGET_UBOOT_DEFCONFIG=nxp3220_daudio2_defconfig
